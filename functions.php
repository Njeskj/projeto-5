...
function vw_fitness_gym_setup() {
	...
	if (is_admin() && ('themes.php' == $pagenow) && isset($_GET['activated']) && wp_get_theme()->get('TextDomain') === 'vw-fitness-gym') {
		wp_redirect(admin_url('themes.php?page=vw_fitness_gym_guide'));
	}
}
endif;
...
if ( ! defined( 'VW_FITNESS_GYM_GO_PRO' ) ) {
	define( 'VW_FITNESS_GYM_GO_PRO', 'https://www.vwthemes.com/themes/fitness-gym-wordpress-theme/');
}
